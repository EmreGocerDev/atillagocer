...
export default function MusicPlayer({ 
  ...
  if (!song) {
    return (
      <div className="fixed bottom-0 left-0 right-0 h-16 lg:h-24 bg-spotify-gray border-t border-black/40 flex items-center justify-center">
  ...
  return (
    <>
      {/* Mobile Mini Player */}
      <div 
        className="lg:hidden fixed bottom-0 left-0 right-0 bg-spotify-gray border-t border-black/40"
      ...
      {/* Desktop Player */}
      <div className="hidden lg:block fixed bottom-0 left-0 right-0 h-24 bg-gradient-to-r from-spotify-gray via-[#181818] to-spotify-gray border-t border-black/40">
        <audio
          ref={audioRef}
          src={song.audio_url}
          onTimeUpdate={handleTimeUpdate}
